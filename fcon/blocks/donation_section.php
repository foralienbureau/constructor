...
if( is_array( $cover ) && isset( $cover['desktop'] ) && $cover['desktop'] ) {
    $cover_desktop  = wp_get_attachment_image_url( (int)$cover['desktop'], 'full');
}

if( is_array( $cover ) && isset( $cover['mobile'] ) && $cover['mobile'] ) {
    $cover_mobile   = wp_get_attachment_image_url((int)$cover['mobile'], 'full');
}
...
if( is_array( $cover ) && isset( $cover['text_color'] ) && $cover['text_color'] ) {
    $custom_classes[] = 'has-text-color';
}

if( is_array( $cover ) && isset( $cover['color'] ) && $cover['color'] ) {
